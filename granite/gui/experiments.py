...
from .style import max_width, app_css

from .widgets import (OptionsBox, MplFigureCanvas,
...
from ..plotting.relational import countplot
...
class TargetSelectionFrame(QtWidgets.QWidget):
    ...
    def ShowSummary(self):
        ...
        if self.targetType == 'Numeric':
            self.canvas.show()
            self.ax.clear()
            countplot(self.project.data, x=self.target, fig=self.fig, ax=self.ax)
...
class ExperimentsTab(WindowManager):
    ...
    def __init__(self, project, parent=None):
        self.project = project
        self.itemsFrame = ItemsView(self, has_button=True)
    ...
    def AddItem(self, experiment):
        ...
        self.itemsFrame.AddItem(widget)
